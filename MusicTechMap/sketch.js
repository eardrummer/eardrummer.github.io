...
function setup() {
	...
	springs[0] = new Spring(200, 50, 30, 0.9, 5, 0.1, springs, 0);
	springs[1] = new Spring(200, 125, 30, 0.9, 5, 0.1, springs, 1);
	springs[2] = new Spring(200, 200, 30, 0.9, 5, 0.1, springs, 2);
}
